...
@Component({
  selector: 'app-implementation-term-option',
  templateUrl: './implementation-term-option.component.html',
  styleUrls: ['./implementation-term-option.component.scss']
})
export class ImplementationTermOptionComponent implements OnInit {
